...
images = glob.glob("/home/chris/Documents/insternship/opencv/calibration/*.png")
print("Images found:", len(images))

print("Chessboards detected:", len(objpoints))
if len(objpoints) == 0:
...
img = cv.imread(
    "C:/Users/nhoei/CameraPoses/CameraPoses/calibration_images/cali00000000.tif"
)
h, w = img.shape[:2]
